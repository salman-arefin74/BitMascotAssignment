        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-4 mx-auto">
                    <h1 class="text-center login-title">Bit Mascot Login</h1>
                    <div class="account-wall">
                        ...
                        <g:form controller="authentication" action="doLogin" class="form-signin">
                            ...
                            <g:link controller="authentication" action="registration" class="btn btn-lg btn-primary btn-block">Register</g:link>
                        </g:form>
                    </div>
                </div>
            </div>
